...
func (m *DatasetMutation) SetTenantID(id int) {
	m.tenant = &id
}

// ClearTenant clears the "tenant" edge to the Tenant entity.
func (m *DatasetMutation) ClearTenant() {
	m.clearedtenant = true
}

// TenantCleared returns if the "tenant" edge to the Tenant entity was cleared.
func (m *DatasetMutation) TenantCleared() bool {
	return m.clearedtenant
}

// TenantID returns the "tenant" edge ID in the mutation.
func (m *DatasetMutation) TenantID() (id int, exists bool) {
	if m.tenant != nil {
...
func (m *DatasetMutation) TenantIDs() (ids []int) {
...
func (m *DatasetMutation) ResetTenant() {
	m.tenant = nil
...
func (m *DatasetMutation) AddedEdges() []string {
	...
	if m.tenant != nil {
		edges = append(edges, dataset.EdgeTenant)
	}
	return edges
}
